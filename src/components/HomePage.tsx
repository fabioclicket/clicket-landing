import ClicketLogo from '../assets/clicket-logo-w.png'
import HomeImage from '../assets/clicket-home-image.png'
...
function HomePage() {
  ...
  return (
    <main className='w-full min-h-screen flex flex-col lg:grid-cols-home lg:grid'>
      <div className='relative max-h-screen flex flex-col justify-center bg-[#5A2D97] p-8 pt-8 pb-20 lg:py-20 lg:pt-8 lg:px-12'>
        <div className='h-full lg:self-end my-auto grid grid-cols-1 gap-10 lg:gap-8 place-content-between'>
          ...
          <div className='self-end my-auto grid gap-8'>
            ...
            <a
              href='#contacto'
              className='w-44 bg-[#A97AE9] text-white text-lg text-center rounded-3xl font-bold font-body py-2 lg:py-3 hover:bg-white hover:text-[#5A2D97] cursor-pointer z-50 transition-colors duration-300'
            >
              Me interesa
            </a>
          </div>
        ...
        >
          <div className='w-full flex items-center justify-between'>
            <p className='w-max flex flex-col text-black font-semibold text-xl'>
              Menú
              <span className='w-full h-1 rounded-2xl bg-[#5A2D97]'></span>
            </p>
            <div
